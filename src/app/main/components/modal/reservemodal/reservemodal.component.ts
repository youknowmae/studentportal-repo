...
//   selectedBookAccession: string | null = null;
...
//   ) {
//     this.selectedBookAccession = data.accession;
...
//   ngOnInit(): void {
//     this.fetchUserData();
//     if (this.selectedBookAccession !== null) {
//       this.fetchBookData(this.selectedBookAccession);
//     }
//   }
...
//   onSubmit(): void {
//     if (this.reservationForm.valid && this.selectedBookAccession !== null) {
//       const reservationData = this.reservationForm.value;
//       const requestData = {
//         user_id: reservationData.id,
//         book_id: this.selectedBookAccession,
...
export class ReservemodalComponent implements OnInit {
  ...
  onSubmit(): void {
    console.log('Form validity:', this.reservationForm.valid);
